    ...
    <html>
      ...
      <body>
        ...
        <table cellspacing="0" width="100%" border="1" bordercolor="white" class="infotable">
          ...
          <tr><td nowrap="1" class ="header">Selected Category</td><td nowrap="1" class ="header">Selected Plugins</td></tr><tr id="color1"><td>Transceiver Feature Access</td><td>Transceiver Features</td></tr>
